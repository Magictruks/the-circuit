    ...
    function App() {
      ...
      const renderOnboarding = () => {
        switch (onboardingStep) {
          ...
          case 'gymSelection': return <GymSelectionScreen preSelectedGymsIds={selectedGymIds} onGymsSelected={handleGymSelectionChange} onNext={handleGymSelectionComplete} currentUser={currentUser} />; // Pass currentUser
          default: return null;
        }
      };
        ...
        if (isAuthenticated && currentUser && onboardingStep === 'complete') {
          ...
          switch (appView) {
            ...
            case 'log':
              ...
              break;
            // UPDATED: Pass activeGymId to DiscoverScreen
            case 'discover': currentScreen = <DiscoverScreen currentUser={currentUser} activeGymId={activeGymId} onNavigate={handleNavigate} />; break;
